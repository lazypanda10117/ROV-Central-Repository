...
void setup()
{
  ...
  zMotor1.attach(zMotorPin1);
  zMotor2.attach(zMotorPin2);
  zMotor3.attach(zMotorPin3);
  zMotor4.attach(zMotorPin4);
...
void startUpProcess(int steps) {
  if (steps == 1) {
    /*
      motor1.write(maxSpeed);
      motor2.write(maxSpeed);
      zMotor1.write(maxSpeed);
      zMotor2.write(maxSpeed);
      zMotor3.write(maxSpeed);
      zMotor4.write(maxSpeed);
    */
    ...
    /*
      motor1.write(stationarySpeed);
      motor2.write(stationarySpeed);
      zMotor1.write(stationarySpeed);
      zMotor2.write(stationarySpeed);
      zMotor3.write(stationarySpeed);
      zMotor4.write(stationarySpeed);
    */
    ...
    /*
      motor1.write(minSpeed);
      motor2.write(minSpeed);
      zMotor1.write(minSpeed);
      zMotor2.write(minSpeed);
      zMotor3.write(minSpeed);
      zMotor4.write(minSpeed);
    */
...
/*
  void transformFromPWM(boolean forward, int spd){
  if(forward == true){
    return map(spd,0,255,stationarySpeed,maxSpeed);
  }else{
    return map(spd,0,255,stationarySpeed,minSpeed);
  }
  }
*/
